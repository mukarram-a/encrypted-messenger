...
Includes encryption tools used by 'NaClProfile.py'
Generates private/public keypairs and other encryption setup tools
to enable encryption and decryption of all user input
...
# v0.3
# 
# The following module is designed to abstract the 
# encoding procedures required when using the NaCl library.
